...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">fartura-hub-angular documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-61d3cc7c69c04d7fee390fe194145200"' : 'data-target="#xs-components-links-module-AppModule-61d3cc7c69c04d7fee390fe194145200"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-61d3cc7c69c04d7fee390fe194145200"' :
                                            'id="xs-components-links-module-AppModule-61d3cc7c69c04d7fee390fe194145200"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/HistoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">HistoriaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PostagensComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PostagensComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/PropositoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PropositoComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/InicioService.html" data-type="entity-link">InicioService</a>
                                </li>
                                <li class="link">
